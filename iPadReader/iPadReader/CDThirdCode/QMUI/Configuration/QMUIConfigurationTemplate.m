...
#pragma mark - Global Color
    ...
    QMUICMI.separatorColor = UIColorMakeWithHex(@"#E5E5E8");                        // UIColorSeparator : 全局默认的分割线颜色，默认用于列表分隔线颜色、UIView (QMUI_Border) 分隔线颜色
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarButtonFont = CDUIFontMake(17);                                  // NavBarButtonFont : QMUINavigationButtonTypeNormal 的字体（由于系统存在一些 bug，这个属性默认不对 UIBarButtonItem 生效）
    QMUICMI.navBarButtonFontBold = CDUIFontMake(20);                          // NavBarButtonFontBold : QMUINavigationButtonTypeBold 的字体
    ...
    QMUICMI.navBarBarTintColor = UIColorWhite;                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    QMUICMI.navBarTintColor = UIColorMakeWithHex(@"#272727");                                     // NavBarTintColor : QMUINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = UIColorMakeWithHex(@"#292A2E");                                 // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = CDUIFontBoldMake(18);                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarBackgroundImage = [[UIImage qmui_imageWithColor:UIColorMakeWithHex(@"#FFFFFF")] resizableImageWithCapInsets:UIEdgeInsetsMake(1, 1, 1, 1)];   // TabBarBackgroundImage : UITabBar 的背景图，建议使用 resizableImage，否则在 UITabBar (NavigationController) 的 setBackgroundImage: 里会每次都视为 image 发生了变化（isEqual: 为 NO）
    ...
    QMUICMI.tabBarItemTitleColor = UIColorMakeWithHex(@"#8C8E91");                                // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = CDTHEME_COLOR;//TabBarTintColor;                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
...
#pragma mark - Toolbar
    ...
    QMUICMI.toolBarButtonFont = CDUIFontMake(16);                                 // ToolBarButtonFont : QMUIToolbarButton 的字体
    
#pragma mark - SearchBar
    
    QMUICMI.searchBarTextFieldBackground = UIColorMakeWithHex(@"#FFFFFF");                                 // SearchBarTextFieldBackground : QMUISearchBar 里的文本框的背景颜色
    QMUICMI.searchBarTextFieldBorderColor = UIColorMakeWithHex(@"#FFFFFF");                                // SearchBarTextFieldBorderColor : QMUISearchBar 里的文本框的边框颜色
    QMUICMI.searchBarBottomBorderColor = nil;                                   // SearchBarBottomBorderColor : QMUISearchBar 底部分隔线颜色
    QMUICMI.searchBarBarTintColor = UIColorMakeWithHex(@"#FFFFFF");                                        // SearchBarBarTintColor : QMUISearchBar 的 barTintColor，也即背景色
    QMUICMI.searchBarTintColor = nil;                                           // SearchBarTintColor : QMUISearchBar 的 tintColor，也即上面的操作控件的主题色
    QMUICMI.searchBarTextColor = UIColorMakeWithHex(@"#292A2E");                                           // SearchBarTextColor : QMUISearchBar 里的文本框的文字颜色
...
#pragma mark - TableView / TableViewCell
    ...
    QMUICMI.tableViewSeparatorColor = UIColorMakeWithHex(@"#EEEEEE");//UIColorSeparator;                         // TableViewSeparatorColor : 列表的分隔线颜色
    
    QMUICMI.tableViewCellNormalHeight = CDREALVALUE_HEIGHT(50);                                     // TableViewCellNormalHeight : QMUITableView 的默认 cell 高度
...
#pragma mark - QMUIBadge
    ...
    QMUICMI.badgeFont = CDUIFontBoldMake(11);                                     // BadgeFont : UIBarButtoItem、UITabBarItem 上的未读数的字体
...
- (UIColor *)themeTintColor {//FF3628
    return UIColorMakeWithHex(@"#FD674F");
}
